...
class FantasyCardFactory(CardFactory):
    def __init__(self) -> None:
        self._creatures: dict[str, tuple[int, str, int, int]] = {
            "Fire Dragon": (5, "Legendary", 7, 5),
            "Goblin Warrior": (2, "Common", 5, 1),
        ...
        self._spells: dict[str, tuple[int, str, str]] = {
        ...
        self._artifact: dict[str, tuple[int, str, int, str]] = {
